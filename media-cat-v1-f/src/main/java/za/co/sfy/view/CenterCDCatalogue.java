...
public class CenterCDCatalogue extends AbstractCenterPanel {

	private static final long serialVersionUID = 1L;
	private ClientServiceInterface clientService;

	public CenterCDCatalogue(ViewFrame viewFrame) {
	...
	public void initComponents(ViewFrame viewFrame) {
		...
		setConstraints(0, 0, GridBagConstraints.FIRST_LINE_START, setTitleJLabel("CD List"), gridBagConstraints);
		...
		setConstraints(0, 2, GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER, 0.2, setCDTable(clientService), gridBagConstraints);
