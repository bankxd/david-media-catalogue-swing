...
public class XDeleteConfirmationCD extends JPanel {

	private ViewFrame v;
	ClientServiceInterface cs;
	String messageReturned;

	public XDeleteConfirmationCD(ViewFrame v, String message) {
		this.v = v;
	...
	public XDeleteConfirmationCD(ViewFrame v) {
		this.v = v;
		initComponents();
	}
	...
	public void initComponents() {
		...
		backBut.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				CDVO mtcd = new CDVO(getMessageReturned());
				boolean deleteResult = cs.delete(mtcd);
				v.putPanel(new ResultPanel(v, deleteResult == true? "Successfully Deleted CD" : "Unsuccessful"));
			}
		});
