...
public class CenterDeleteCD extends AbstractCenterPanel {
	
	private static final long serialVersionUID = 1L;
	ClientServiceInterface clientService;

	public CenterDeleteCD(ViewFrame viewFrame) {
	...
	public void initComponents(ViewFrame viewFrame) {
		...
		setConstraints(0, 3, GridBagConstraints.VERTICAL, GridBagConstraints.CENTER, 0.2, setTableBox(setCDTable(clientService, viewFrame)), gridBagConstraints);
